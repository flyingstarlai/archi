...
import dev.starlai.archi.ui.setting.SettingsFragment;
import dev.starlai.archi.ui.tabhost.TabHostFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.containerView, new TabHostFragment()).commit();
            item.setChecked(true);
    ...
    private void clearStateChecked() {
